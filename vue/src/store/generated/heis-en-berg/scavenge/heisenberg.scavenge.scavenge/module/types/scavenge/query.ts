...
export class QueryClientImpl implements Query {
  ...
  Commit(request: QueryGetCommitRequest): Promise<QueryGetCommitResponse> {
    ...
    const promise = this.rpc.request('heisenberg.scavenge.scavenge.Query', 'Commit', data)
  ...
  CommitAll(request: QueryAllCommitRequest): Promise<QueryAllCommitResponse> {
    ...
    const promise = this.rpc.request('heisenberg.scavenge.scavenge.Query', 'CommitAll', data)
  ...
  Scavenge(request: QueryGetScavengeRequest): Promise<QueryGetScavengeResponse> {
    ...
    const promise = this.rpc.request('heisenberg.scavenge.scavenge.Query', 'Scavenge', data)
  ...
  ScavengeAll(request: QueryAllScavengeRequest): Promise<QueryAllScavengeResponse> {
    ...
    const promise = this.rpc.request('heisenberg.scavenge.scavenge.Query', 'ScavengeAll', data)
